...
use Core\Model;
use Database\Migrations\CreateProofsTable;

class Proof extends Model implements Models
{
    public static $entity = "proofs";
    ...
    {
        $sql = (new CreateProofsTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateProofsTable())->down(self::$entity);
