...
use Core\Model;
use Database\Migrations\CreatePhotosTable;

class Photo extends Model implements Models
{
    public static $entity = "photos";
    ...
    {
        $sql = (new CreatePhotosTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreatePhotosTable())->down(self::$entity);
