    ...
    <form id="login-register" action="#" method="POST" class="form-horizontal">
        <fieldset class="fieldset">
            ...
            <div class="form-row mb-2">
                ...
                <div class="col-md">
                    <label for="senha2" class="label">Confirme: </label><br>
            ...
            <div class="row mr-4" >
                <div class="col">
                    <label for="cargo" class="label">Cargo: </label><br>
                ...
                <div class="col-md">
                    ...
                    <label class="label"> NÃO </label><input type="radio" name="Visivel" value=0 <?= (isset($user) && $user->Visivel == "0" ? "checked" : null) ?> />
                </div><!-- col -->
            </div>
        </fieldset>
