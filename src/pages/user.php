<div id="user">
    <header class="header row form-inline">
        <div class="buttons" style="width: 100%; text-align: right">
            <button class="button btnAction" value="add" title="Adiciona" data="">Adicionar</button>
        </div>
    </header>
    <main id="exhibition" >
                    ...
                    <?php if (isset($users)):
                        ...
                        foreach ($users as $user):
                            ...
                            <tr <?= ($login !== $user->login ?: "style='background: #c3d2dd'") ?> >
                                ...
                                <td title="Edita" data-id="<?= $user->id ?>"
                                    data="<?= $user->login ?>" ><i class="fa fa-pencil" ></i>
                                </td>
                                <td title="Exclui" data-id="<?= $user->id ?>"
                                    data="<?= $user->login ?>" ><i class="fa fa-times"></i>
                                </td>
                                <td title="Reseta" data-id="<?= $user->id ?>"
                                    data="<?= $user->login ?>" ><i class="fa fa-key "></i>
                                </td>
                            </tr>
